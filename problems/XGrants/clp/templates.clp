...
(deftemplate ASSIMILATION2::UPDATE-REV-TIME2 (slot parameter ) (slot avg-revisit-time-global#) (slot avg-revisit-time-US#)(slot factHistory))
(deftemplate ASSIMILATION2::UPDATE-OVERLAP (slot parameter ) (slot overlap-time#) (slot factHistory))
