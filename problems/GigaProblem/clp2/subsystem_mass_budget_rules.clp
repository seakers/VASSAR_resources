...
(defrule MASS-BUDGET::design-avionics-subsystem 
    ...
    (declare (salience 10))
    ?miss <- (MANIFEST::Satellite (avionics-mass# nil) (payload-mass# ?m&~nil) (factHistory ?fh))
    =>
...
(defrule MASS-BUDGET::design-thermal-subsystem 
    ...
    (declare (salience 10))
    ?miss <- (MANIFEST::Satellite (thermal-mass# nil) (payload-mass# ?m&~nil) (factHistory ?fh))
    =>
...
(defrule MASS-BUDGET::design-structure-subsystem 
    ...
    (declare (salience 10))
    ?miss <- (MANIFEST::Satellite (structure-mass# nil) (payload-mass# ?m&~nil) (factHistory ?fh))
    =>
...
(defrule MASS-BUDGET::add-launch-adapter 
    ...
    (declare (salience 10))
    ?miss <- (MANIFEST::Satellite (adapter-mass nil) (satellite-dry-mass ?m&~nil) (factHistory ?fh) )
    =>
