...
(defrule CRITIQUE-PERFORMANCE::passive-optica-instrument-in-DD-orbit
    ...
    (call ?*p* addElement (new java.lang.String 
        (str-cat "Instrument " ?instr " should not be in orbit " ?o ", because dawn-dusk orbits have insufficient illumination for passive optical instruments." ))))
...
(defrule CRITIQUE-PERFORMANCE::atmospheric-chemistry-instrument-in-AM-orbit
    ...
    =>
    (call ?*p* addElement (new java.lang.String
        (str-cat "Instrument " ?instr " should not be in orbit " ?o ", because atmospheric chemistry instruments should observe in the afternoon when pollution is maximum." ))))
...
(defrule CRITIQUE-PERFORMANCE::side-looking-instrument-in-less-400-km-orbit
    ...
    =>
    (call ?*p* addElement (new java.lang.String
        (str-cat "Instrument " ?instr " should not be in orbit " ?o ", because distortion will likely be unacceptable at low altitudes." ))))
